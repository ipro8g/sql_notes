...
--
-- Host: localhost
-- Generation Time: Apr 15, 2022 at 06:05 AM
...
--
-- Table structure for table `asst_referee`
--

CREATE TABLE `asst_referee` (
  `ass_ref_id` int(11) DEFAULT NULL,
  `ass_ref_name` varchar(255) DEFAULT NULL,
  `country_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `asst_referee`
--

INSERT INTO `asst_referee` (`ass_ref_id`, `ass_ref_name`, `country_id`) VALUES
...
CREATE TABLE `goal_details` (
  ...
  `play_stage` varchar(255) DEFAULT NULL,
  `goal_schedule` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `match_capitain`
--

CREATE TABLE `match_capitain` (
  `match_no` int(11) DEFAULT NULL,
  `team_id` int(11) DEFAULT NULL,
  `player_capitain` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `match_capitain`
--

INSERT INTO `match_capitain` (`match_no`, `team_id`, `player_capitain`) VALUES
(1, 1207, '160140'),
(1, 1216, '160349'),
(2, 1201, '160013'),
(2, 1221, '160467'),
...
CREATE TABLE `match_mast` (
  ...
  `decided_by` varchar(255) DEFAULT NULL,
  `goal_score` varchar(255) DEFAULT NULL,
...
INSERT INTO `match_mast` (`match_no`, `play_stage`, `play_date`, `results`, `decided_by`, `goal_score`, `venue_id`, `referee_id`, `audience`, `plr_of_match`, `stop1_sec`, `stop2_sec`) VALUES
...
CREATE TABLE `penalty_shootout` (
  `kick_id` int(11) DEFAULT NULL,
  `match_no` int(11) DEFAULT NULL,
  `team_id` int(11) DEFAULT NULL,
  `player_id` int(11) DEFAULT NULL,
  `score_goal` varchar(255) DEFAULT NULL,
...
CREATE TABLE `player_booked` (
  ...
  `sent_off` varchar(255) DEFAULT NULL,
  `play_schedule` varchar(255) DEFAULT NULL,
...
(1, 11216, 160349, 32, 'NT', NULL, 1),
(1, 1216, 160355, 45, 'NT', NULL, 1),
(1, 1207, 160159, 69, 'Y', 'NT', 2),
(1, 1216, 160360, 78, 'NT', NULL, 2),
(2, 1221, 160470, 14, 'NT', NULL, 1),
(2, 1201, 160013, 23, 'NT', NULL, 1),
(2, 1201, 160013, 36, 'NT', NULL, 1),
(2, 1201, 160014, 63, 'NT', NULL, 2),
(2, 1221, 160472, 66, 'NT', NULL, 2),
(2, 1201, 160015, 89, 'NT', NULL, 2),
(2, 1201, 160009, 93, 'NT', NULL, 2),
(3, 1218, 160401, 2, 'ST', NULL, 2),
(3, 1218, 160406, 31, 'NT', NULL, 1),
(3, 1218, 160408, 78, 'NT', NULL, 2),
(3, 1218, 160411, 80, 'NT', NULL, 2),
(3, 1218, 160407, 83, 'NT', NULL, 2),
(4, 1206, 160120, 62, 'NT', NULL, 2),
(4, 1217, 160377, 72, 'NT', NULL, 2),
(5, 1222, 160505, 31, 'NT', NULL, 1),
(5, 1222, 160490, 48, 'NT', NULL, 2),
(5, 1204, 160077, 80, 'NT', NULL, 2),
(5, 1222, 160502, 91, 'NT', NULL, 2),
(6, 1213, 160290, 65, 'NT', NULL, 2),
(6, 1212, 160258, 69, 'NT', NULL, 2),
(6, 1213, 160284, 89, 'NT', NULL, 2),
(7, 1223, 160518, 68, 'NT', NULL, 2),
(8, 1205, 160100, 61, 'NT', NULL, 2),
(9, 1215, 160336, 43, 'NT', NULL, 1),
(9, 1220, 160445, 61, 'NT', NULL, 2),
(9, 1215, 160341, 77, 'NT', NULL, 2),
(10, 1211, 160236, 65, 'NT', NULL, 2),
(10, 1211, 160248, 75, 'NT', NULL, 2),
(10, 1211, 160235, 78, 'NT', NULL, 2),
(10, 1211, 160245, 84, 'NT', NULL, 2),
(10, 1203, 160057, 93, 'NT', NULL, 2),
(11, 1202, 160027, 33, 'NT', NULL, 1),
(11, 1202, 160027, 66, 'Y', 'NT', 2),
(11, 1209, 160204, 80, 'NT', NULL, 2),
(12, 1210, 160227, 2, 'ST', NULL, 2),
(12, 1210, 160221, 55, 'NT', NULL, 2),
(13, 1218, 160395, 46, 'NT', NULL, 2),
(14, 1221, 160480, 2, 'ST', NULL, 2),
(14, 1216, 160361, 22, 'NT', NULL, 1),
(14, 1216, 160357, 24, 'NT', NULL, 1),
(14, 1216, 160367, 37, 'NT', NULL, 1),
(14, 1221, 160477, 50, 'NT', NULL, 2),
(14, 1216, 160352, 76, 'NT', NULL, 2),
(15, 1201, 160015, 55, 'NT', NULL, 2),
(15, 1201, 160011, 81, 'NT', NULL, 2),
(15, 1207, 160152, 88, 'NT', NULL, 2),
(16, 1224, 160535, 61, 'NT', NULL, 2),
(17, 1223, 160528, 40, 'NT', NULL, 1),
(17, 1212, 160272, 63, 'NT', NULL, 2),
(17, 1223, 160523, 67, 'NT', NULL, 2),
(17, 1212, 160266, 87, 'NT', NULL, 2),
(17, 1212, 160259, 90, 'NT', NULL, 2),
(18, 1208, 160175, 3, 'NT', NULL, 1),
(18, 1213, 160294, 3, 'ST', NULL, 2),
(18, 1208, 160177, 34, 'NT', NULL, 1),
(18, 1213, 160293, 45, 'NT', NULL, 1),
(18, 1213, 160288, 55, 'NT', NULL, 2),
(18, 1208, 160165, 67, 'NT', NULL, 2),
(19, 1211, 160242, 69, 'NT', NULL, 2),
(19, 1220, 160447, 89, 'NT', NULL, 2),
(19, 1211, 160231, 94, 'NT', NULL, 2),
(20, 1204, 160080, 14, 'NT', NULL, 1),
(20, 1205, 160101, 72, 'NT', NULL, 2),
(20, 1204, 160081, 74, 'NT', NULL, 2),
(20, 1204, 160078, 88, 'NT', NULL, 2),
(21, 1219, 160424, 2, 'NT', NULL, 1),
(21, 1222, 160504, 9, 'NT', NULL, 1),
(21, 1222, 160500, 41, 'NT', NULL, 1),
(22, 1215, 160334, 42, 'NT', NULL, 1),
(22, 1203, 160056, 49, 'NT', NULL, 2),
(23, 1209, 160199, 2, 'ST', NULL, 2),
(23, 1210, 160229, 42, 'NT', NULL, 1),
(23, 1210, 160227, 75, 'NT', NULL, 2),
(23, 1210, 160216, 77, 'NT', NULL, 2),
(23, 1209, 160192, 81, 'NT', NULL, 2),
(23, 1209, 160197, 83, 'NT', NULL, 2),
(24, 1202, 160028, 6, 'NT', NULL, 1),
(24, 1214, 160321, 31, 'NT', NULL, 1),
(24, 1214, 160307, 40, 'NT', NULL, 1),
(24, 1202, 160037, 47, 'NT', NULL, 2),
(24, 1202, 160029, 78, 'NT', NULL, 2),
(24, 1202, 160042, 86, 'NT', NULL, 2),
(25, 1201, 160012, 6, 'NT', NULL, 1),
(25, 1216, 160353, 54, 'NT', NULL, 2),
(25, 1201, 160017, 85, 'NT', NULL, 2),
(25, 1216, 160356, 85, 'NT', NULL, 2),
(25, 1216, 160364, 91, 'NT', NULL, 2),
(25, 1201, 160007, 95, 'NT', NULL, 2),
(26, 1207, 160147, 25, 'NT', NULL, 1),
(26, 1207, 160145, 83, 'NT', NULL, 2),
(27, 1224, 160551, 16, 'NT', NULL, 1),
(27, 1217, 160383, 64, 'NT', NULL, 2),
(28, 1218, 160409, 24, 'NT', NULL, 1),
(28, 1206, 160119, 52, 'NT', NULL, 2),
(29, 1223, 160520, 25, 'NT', NULL, 1),
(29, 1223, 160513, 38, 'NT', NULL, 1),
(29, 1213, 160290, 60, 'NT', NULL, 2),
(31, 1222, 160491, 35, 'NT', NULL, 1),
(31, 1205, 160108, 36, 'NT', NULL, 1),
(31, 1205, 160107, 39, 'Y', 'NT', 1),
(31, 1222, 160490, 50, 'NT', NULL, 2),
(31, 1205, 160112, 87, 'NT', NULL, 2),
(32, 1204, 160087, 29, 'NT', NULL, 1),
(32, 1204, 160079, 70, 'NT', NULL, 2),
(32, 1204, 160076, 70, 'NT', NULL, 2),
(32, 1204, 160085, 88, 'NT', NULL, 2),
(33, 1210, 160218, 36, 'NT', NULL, 1),
(33, 1210, 160230, 51, 'NT', NULL, 2),
(33, 1202, 160045, 70, 'NT', NULL, 2),
(33, 1210, 160220, 78, 'NT', NULL, 2),
(33, 1210, 160208, 82, 'NT', NULL, 2),
(34, 1209, 160190, 13, 'NT', NULL, 1),
(34, 1209, 160191, 28, 'NT', NULL, 1),
(34, 1209, 160203, 34, 'NT', NULL, 1),
(34, 1209, 160202, 56, 'NT', NULL, 2),
(35, 1211, 160233, 39, 'NT', NULL, 1),
(35, 1215, 160343, 39, 'NT', NULL, 1),
(35, 1215, 160332, 73, 'NT', NULL, 2),
(35, 1211, 160234, 78, 'NT', NULL, 2),
(35, 1211, 160253, 87, 'NT', NULL, 2),
(35, 1211, 160251, 93, 'NT', NULL, 2),
(36, 1203, 160064, 1, 'ST', NULL, 1),
(36, 1203, 160055, 30, 'NT', NULL, 1),
(36, 1220, 160451, 72, 'NT', NULL, 2),
(37, 1221, 160470, 55, 'NT', NULL, 2),
(37, 1213, 160282, 58, 'NT', NULL, 2),
(38, 1212, 160266, 44, 'NT', NULL, 1),
(38, 1224, 160538, 58, 'NT', NULL, 2),
(38, 1212, 160267, 67, 'NT', NULL, 2),
(38, 1224, 160544, 92, 'NT', NULL, 2),
(39, 1214, 160318, 78, 'NT', NULL, 2),
(40, 1215, 160328, 25, 'NT', NULL, 1),
(40, 1207, 160152, 27, 'NT', NULL, 1),
(40, 1215, 160334, 41, 'NT', NULL, 1),
(40, 1207, 160147, 44, 'NT', NULL, 1),
(40, 1215, 160329, 66, 'Y', 'NT', 2),
(40, 1215, 160343, 72, 'NT', NULL, 2),
(41, 1218, 160407, 2, 'ST', NULL, 2),
(41, 1218, 160401, 13, 'NT', NULL, 1),
(41, 1208, 160169, 46, 'NT', NULL, 2),
(41, 1208, 160168, 67, 'NT', NULL, 2),
(42, 1209, 160192, 34, 'NT', NULL, 1),
(42, 1209, 160194, 47, 'NT', NULL, 2),
(42, 1209, 160196, 61, 'NT', NULL, 2),
(42, 1203, 160056, 67, 'NT', NULL, 2),
(42, 1203, 160065, 89, 'NT', NULL, 2),
(42, 1203, 160061, 91, 'NT', NULL, 2),
(42, 1209, 160207, 92, 'NT', NULL, 2),
(43, 1219, 160431, 2, 'ST', NULL, 2),
(43, 1211, 160238, 24, 'NT', NULL, 1),
(43, 1219, 160436, 41, 'NT', NULL, 1),
(43, 1211, 160252, 54, 'NT', NULL, 2),
(43, 1211, 160245, 89, 'NT', NULL, 2),
(43, 1219, 160427, 89, 'NT', NULL, 2),
(43, 1219, 160421, 89, 'NT', NULL, 2),
(44, 1210, 160208, 38, 'NT', NULL, 1),
(44, 1206, 160137, 47, 'NT', NULL, 2),
(44, 1210, 160222, 65, 'NT', NULL, 2),
(45, 1214, 160318, 2, 'ST', NULL, 2),
(45, 1213, 160282, 42, 'NT', NULL, 1),
(45, 1213, 160281, 66, 'NT', NULL, 2),
(45, 1214, 160310, 70, 'NT', NULL, 2),
(45, 1213, 160290, 89, 'NT', NULL, 2),
(46, 1224, 160535, 5, 'NT', NULL, 1),
(46, 1224, 160533, 16, 'NT', NULL, 1),
(46, 1224, 160536, 24, 'NT', NULL, 1),
(46, 1203, 160061, 59, 'NT', NULL, 2),
(46, 1224, 160544, 75, 'NT', NULL, 2),
(46, 1203, 160050, 85, 'NT', NULL, 2),
(47, 1211, 160247, 56, 'NT', NULL, 2),
(47, 1211, 160238, 57, 'NT', NULL, 2),
(47, 1211, 160246, 59, 'NT', NULL, 2),
(47, 1208, 160168, 90, 'NT', NULL, 2),
(47, 1208, 160180, 112, 'NT', NULL, 2),
(48, 1210, 160221, 58, 'NT', NULL, 2),
(48, 1207, 160149, 75, 'NT', NULL, 2),
(49, 1224, 160540, 8, 'NT', NULL, 1),
(49, 1224, 160533, 62, 'NT', NULL, 2),
(49, 1214, 160303, 71, 'NT', NULL, 2),
(49, 1214, 160322, 72, 'NT', NULL, 2),
(49, 1224, 160547, 88, 'NT', NULL, 2),
(50, 1208, 160177, 1, 'ST', NULL, 1),
(50, 1208, 160172, 36, 'NT', NULL, 1),
(50, 1207, 160143, 43, 'NT', NULL, 1),
(50, 1208, 160180, 45, 'NT', NULL, 1),
(50, 1208, 160173, 50, 'NT', NULL, 2),
(50, 1207, 160152, 75, 'NT', NULL, 2),
(51, 1214, 160304, 34, 'NT', NULL, 1),
(51, 1214, 160313, 62, 'NT', NULL, 2),
(51, 1207, 160149, 80, 'NT', NULL, 2),
(51, 1214, 160308, 95, 'ET', NULL, 1),
(51, 1207, 160153, 97, 'ET', NULL, 1),
(51, 1214, 160318, 98, 'ET', NULL, 1),
(51, 1207, 160145, 107, 'ET', NULL, 2),
(51, 1207, 160155, 115, 'ET', NULL, 2),
(51, 1214, 160306, 119, 'ET', NULL, 2),
(51, 1214, 160302, 122, 'ET', NULL, 2);
...
CREATE TABLE `player_mast` (
  ...
  `posi_to_play` varchar(255) DEFAULT NULL,
  `dt_of_bir` date DEFAULT NULL,
  `age` int(11) DEFAULT NULL,
  `playing_club` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(160397, 1218, 23, 'MatusKozacik', 'GK', '1983-12-27', 32, 'Plzen'),
...
CREATE TABLE `playing_position` (
  ...
  `position_desc` varchar(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `soccer_country` (
  `country_id` int(11) DEFAULT NULL,
  `country_abbr` varchar(255) DEFAULT NULL,
